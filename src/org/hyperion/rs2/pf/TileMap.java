...
public class TileMap {
	 ...
	 */
	public static final Tile EMPTY_TILE = new Tile(Tile.NORTH_TRAVERSAL_PERMITTED
		| Tile.EAST_TRAVERSAL_PERMITTED
	...
	/**
	 * Creates a blank tile map with the specified width and height.
	 * The map is filled with <code>EMPTY_TILE</code>s.
